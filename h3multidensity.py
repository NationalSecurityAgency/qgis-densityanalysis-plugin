...
class H3MultiLayerDensityAlgorithm(QgsProcessingAlgorithm):
    ...
    def name(self):
        return 'h3multidensity'

    def displayName(self):
        return 'H3 multi-layer density grid'

    def icon(self):
        return QIcon(os.path.join(os.path.dirname(__file__), 'icons/h3multidensity.svg'))
    ...
    def createInstance(self):
        return H3MultiLayerDensityAlgorithm()
